...
let editingId          = null;      // se !== null → modo edição
let currentDetailId    = null;      // id mostrado no detalhe
let currentDetailData  = null;      // dados do detalhe
...
/* ------------------------------------------------------------------ */
/* 1-A. Preenche filtro de centros                                     */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* 1-B. Carrega formulário para edição                                 */
/* ------------------------------------------------------------------ */
